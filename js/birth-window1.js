const SVC_CODE = 'B';
const SVC_NAME = 'Birth Certificate';
const SVC_WIN = 'Window 1';
let STAFF_NAME = 'Fe Dimaculangan'; // fallback until real login; overwritten with the logged-in user's display_name
const REQUIRED_ROLE = 'birth';
const ALL_SVCS = {
