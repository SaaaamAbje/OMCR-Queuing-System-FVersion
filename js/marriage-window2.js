const SVC_CODE = 'M';
const SVC_NAME = 'Marriage Certificate';
const SVC_WIN = 'Window 2';
let STAFF_NAME = 'Ivy'; // fallback until real login; overwritten with the logged-in user's display_name
const REQUIRED_ROLE = 'marriage';
const ALL_SVCS = {
